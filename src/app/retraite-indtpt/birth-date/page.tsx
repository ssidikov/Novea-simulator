          ...
          <div className='w-full max-w-[600px] bg-white/8 rounded-[10px] shadow-lg px-6 sm:px-10 py-8 sm:py-10 flex flex-col gap-6 mt-8 sm:mt-[60px]'>
            ...
            <div className='bg-[#67d39d]/20 rounded-lg p-4 flex gap-3 mt-2'>
              ...
              <p className='text-white text-[13px] leading-5 opacity-70 max-w-[435px]'>
                L'âge pris en compte est celui que vous aurez au 31 décembre de l'année précédente.
                Cette information nous permet de calculer votre cotisation avec précision.
              </p>
            </div>
          </div>
