      ...
      <div className="space-y-6 text-center">
        <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-8">
          ...
          <p className="text-gray-700">
            En tant que salarié d'entreprise, votre mutuelle est généralement
            proposée par votre employeur. Veuillez vous rapprocher de votre
            service RH pour plus d'informations.
          </p>
        </div>
