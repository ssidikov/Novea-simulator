              ...
              <div className="flex items-center gap-5">
                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-white">
                    ...
                    <path d="M9 13C5.69 13 3 15.69 3 19H15C15 15.69 12.31 13 9 13Z" fill="currentColor"/>
                    <path d="M17 11C18.66 11 20 9.66 20 8C20 6.34 18.66 5 17 5C15.34 5 14 6.34 14 8C14 9.66 15.34 11 17 11Z" fill="currentColor"/>
                    <path d="M21 19C21 16.79 19.21 15 17 15C16.45 15 15.95 15.11 15.5 15.3C16.43 16.36 17 17.63 17 19H21Z" fill="currentColor"/>
                  </svg>
                </div>
                <div className="flex flex-col gap-[3px] items-start text-left">
                  <p className="text-white text-base font-semibold leading-6">
