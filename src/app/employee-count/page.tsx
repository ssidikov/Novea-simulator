...
import { ArrowLeftIcon, Users2Icon, Users3Icon, BuildingOfficeIcon } from '@/components/Icons';
...
function EmployeeCountCard({ icon, title, description, onClick }: EmployeeCountCardProps) {
  return (
    <button
      onClick={onClick}
      ...
      <div className="mx-auto w-full max-w-[920px] px-4 py-[149px] sm:px-[67px]">
        <div className="flex w-full flex-col items-center gap-[62px]">
          ...
          <div className="flex w-full flex-col items-center gap-[22px] px-4">
            ...
            <h1 className="w-full max-w-[800px] whitespace-pre-wrap text-center font-['Poppins',sans-serif] text-4xl font-extrabold leading-[70px] text-white sm:text-[56px]">
              {`Combien de `}
