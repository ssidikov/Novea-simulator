...
export default function SeulOuPlusieurPage() {
  const router = useRouter()
  const { formData, updateFormData } = useFormData()

  const handleSelect = (choice: 'seul' | 'plusieurs') => {
    updateFormData({ sasSeulOuPlusieur: choice })
    const nextRoute = getNextRoute('/legal-form/seul-ou-plusieurs', {
      ...formData,
      sasSeulOuPlusieur: choice,
    })
