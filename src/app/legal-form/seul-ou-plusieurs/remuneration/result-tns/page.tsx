...
export default function ResultTnsPage() {
        ...
        <div className='flex w-full flex-col items-center gap-8'>
          ...
          <div className='mt-8 flex w-full max-w-[700px] flex-col gap-4 sm:flex-row lg:mt-[60px]'>
            ...
            <button
              ...
              className="font-['Poppins',sans-serif] flex h-[52px] flex-1 items-center justify-center rounded-[10px] border-2 border-[#67d39d] bg-white/10 text-base font-semibold text-[#67d39d] transition-all hover:bg-white/20">
