...
export default function ResultEntreprisePage() {
  ...
  return (
    <div className='relative min-h-screen w-full overflow-x-hidden bg-[#0a253a]'>
      ...
      <div className='pointer-events-none fixed left-0 top-0 h-[1130.789px] w-[1054px] opacity-5' />
      ...
      <div className='pointer-events-none fixed left-[71.34px] top-[688.38px] h-[342.414px] w-[342.414px] rounded-full bg-[#55c1ff] opacity-10 blur-[57.069px]' />
      ...
      {/* Main content */}
      <div className='mx-auto flex min-h-screen w-full max-w-[930px] flex-col items-center px-4 py-20 sm:px-8 lg:px-[59px] lg:py-20'>
        <div className='flex w-full flex-col items-center gap-8'>
          ...
          {/* Next steps card */}
          <div className='mt-12 w-full max-w-[700px] rounded-[10px] bg-white/8 px-6 py-10 shadow-lg sm:px-10 lg:mt-[114.79px]'>
          ...
          <div className='mt-8 flex w-full max-w-[700px] flex-col gap-4 sm:flex-row lg:mt-[60px]'>
            <button
              ...
              className="font-['Poppins',sans-serif] flex h-[52px] flex-1 items-center justify-center rounded-[10px] bg-[#55c1ff] text-base font-semibold text-white transition-all hover:bg-[#4ab3f0]">
              Demander un devis
            </button>
            <button
              onClick={handleContactAdvisor}
              className="font-['Poppins',sans-serif] flex h-[52px] flex-1 items-center justify-center rounded-[10px] border-2 border-[#55c1ff] bg-white text-base font-semibold text-[#55c1ff] transition-all hover:bg-gray-50">
