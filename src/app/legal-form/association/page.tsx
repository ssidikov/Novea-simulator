        ...
        <div className='w-full max-w-[930px] flex flex-col items-center gap-8 px-[90px]'>
          ...
          <div className='w-[100px] h-[100px] rounded-full bg-gradient-to-b from-[#67d39d] to-[#55c1ff] flex items-center justify-center'>
            <svg width='50' height='50' viewBox='0 0 50 50' fill='none' className='text-white'>
              ...
              />
              <path
                d='M10 40C10 32.268 16.268 26 24 26H26C33.732 26 40 32.268 40 40V42C40 43.1046 39.1046 44 38 44H12C10.8954 44 10 43.1046 10 42V40Z'
                fill='currentColor'
              />
            </svg>
          </div>
          ...
          <h1 className='text-[56px] font-extrabold text-center text-white leading-[70px] max-w-[606px]'>
            Il vous faut un <span className='text-[#67d29d]'>seul contrat</span> si vous avez des
            salariés
          </h1>

          {/* Description */}
          <p className='text-white/90 text-lg text-center max-w-[739px] leading-[28.981px]'>
            En tant qu'association de loi 1901, vous devez souscrire à un contrat d'assurance
            collectif uniquement si vous employez des salariés.
          </p>

          {/* Who can be covered card */}
          <div className='w-[700px] bg-white/8 rounded-[10px] shadow-lg px-10 py-10 flex flex-col gap-6 mt-[157px]'>
            <h3 className='text-white text-2xl font-semibold leading-8'>Qui peut être couvert ?</h3>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div className='flex flex-col gap-1'>
                  ...
                  <p className='text-white/70 text-sm leading-6 max-w-[535px]'>
                    Les dirigeants, tels que le président ou le trésorier, peuvent souscrire à ce
                    contrat d'assurance santé uniquement s'ils ont signé un contrat de travail
                    (rémunéré) avec l'association.
                  </p>
                </div>
              </div>
              ...
              <div className='bg-[#67d39d] rounded-[10px] px-5 py-5 mt-2'>
                <p className='text-white text-sm leading-6'>
                  ...
                  Si vous n'avez pas de salariés, les dirigeants bénévoles ne peuvent pas souscrire
                  à un contrat collectif d'entreprise.
                </p>
              </div>
            </div>
          </div>
