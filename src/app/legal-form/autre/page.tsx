...
import { CheckIcon, ArrowRightIcon, CloseIcon, DocumentIcon } from '@/components/Icons'
      ...
      <div className='flex flex-col items-center justify-start pt-20 px-4'>
        <div className='w-full max-w-[930px] flex flex-col items-center gap-8'>
          ...
          <div className='flex flex-col items-center gap-3'>
            <h1 className='text-[56px] font-extrabold text-center text-white leading-[70px]'>
              Il vous faut un
            </h1>
            <h2 className='text-[64px] font-extrabold text-center text-[#67d29d] leading-[70px]'>
              contrat TNS
            </h2>
          </div>
          ...
          <p className='text-white/90 text-lg text-center max-w-[662px] leading-[28.981px]'>
            Pour le gérant associé unique, il ou elle peut uniquement souscrire à un contrat TNS
