...
export default function EurlGerantSalariePage() {
  const router = useRouter()
  const { formData, updateFormData } = useFormData()

  const handleSelect = (choice: 'oui' | 'non') => {
    updateFormData({ gerantSalarie: choice })
    const nextRoute = getNextRoute('/legal-form/eurl-gerant-salarie', {
      ...formData,
      gerantSalarie: choice,
    })
